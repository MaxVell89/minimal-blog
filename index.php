          ...
          <section class="content__left col-md-8">
            ...
            <div class="block">
              ...
              <div class="block__content">
                ...
                <?php 
                  $article = mysqli_query($connect, 'SELECT * FROM `articles` ORDER BY `id` DESC LIMIT 10');
            ...
            <div class="block">
              <a href="/article.php?category=7">Все записи</a>
              <h3>Безопасность [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">

                    <?php 
                  $article = mysqli_query($connect, 'SELECT * FROM `articles` WHERE `category_id` = 6 ORDER BY `id` DESC LIMIT 10');
                  while ( $art = mysqli_fetch_assoc($article) ) {
                ?>
            ...
            <div class="block">
              <a href="/article.php?category=4">Все записи</a>
              <h3>Программирование [Новейшее]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">

                  <?php 
                  $article = mysqli_query($connect, 'SELECT * FROM `articles` WHERE `category_id` = 4 ORDER BY `id` DESC LIMIT 10');
                  while ( $art = mysqli_fetch_assoc($article) ) {
                ?>
